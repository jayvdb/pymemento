...
class TestOriginalResource(unittest.TestCase):
    ...
    def test_getURIsFromHeaders(self):
        ...
        self.assertEquals(orig._getURIGFromHeaders(inputHeaders))
        self.assertEquals(orig._getURITFromHeaders(inputHeaders))
    ...
    def test_getURIsFromNoneInHeaders(self):
        ...
        self.assertIsNone(orig._getURIGFromHeaders(inputHeaders))
        self.assertIsNone(orig._getURITFromHeaders(inputHeaders))
